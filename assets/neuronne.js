let score = 0;
let totQuestions = questionsNeurone.length;
...
function loadQuestion (questionIndex) {
    let q = questionsNeurone[questionIndex];
...
// Vérification des réponses
    ...
    answer_tab = "";
    for (let index = 0; index < questionsNeurone[currentQuestion].answer.length; index++) {
        answer_tab += questionsNeurone[currentQuestion].answer[index] + ", ";
    }
