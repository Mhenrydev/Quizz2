...
let score = 0;
let totQuestions = questionsCPAM.length;
...
function loadQuestion (questionIndex) {
    let q = questionsCPAM[questionIndex];
...
// Vérification des réponses
    ...
    answer_tab = "";
    for (let index = 0; index < questionsCPAM[currentQuestion].answer.length; index++) {
        answer_tab += questionsCPAM[currentQuestion].answer[index] + ", ";
    }
