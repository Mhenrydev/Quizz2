...
let score = 0;
let totQuestions = questionsDigestif.length;
...
function loadQuestion(questionIndex) {
    let q = questionsDigestif[questionIndex];
...
function checkAnswer() {
    ...
    answer_tab = "";
    for (let index = 0; index < questionsDigestif[currentQuestion].answer.length; index++) {
        answer_tab += questionsDigestif[currentQuestion].answer[index] + ", ";
    }
